...
let inviteCodes = ['RtGKzL2lQwOrdtKfE9c0gyZ9u3ySYyR8DPaN6696RrTS3HZW2g', 'WNS6zemgDUbvfs_WW41tklvcGxpIt29bbE7p']
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      await getInfo('', true);
      $.newShareCodes = ['RtGKzL2lQwOrdtKfE9c0gyZ9u3ySYyR8DPaN6696RrTS3HZW2g', 'WNS6zemgDUbvfs_WW41tklvcGxpIt29bbE7p']
