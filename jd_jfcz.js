...
[task_local]
#见缝插针
18 8,18 * * * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_jfcz.js, tag=见缝插针, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "18 8,18 * * *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_jfcz.js,tag=见缝插针
===================================Surge================================
见缝插针 = type=cron,cronexp="18 8,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_jfcz.js
====================================小火箭=============================
见缝插针 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_jfcz.js, cronexpr="18 8,18 * * *", timeout=3600, enable=true
 */
const $ = new Env('见缝插针');
