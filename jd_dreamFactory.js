      ...
      if (QueryTuanRes && QueryTuanRes.ret === 0) {
        ...
        for (let item of tuanInfo) {
          ...
          if (realTuanNum === tuanNum) {
            ...
            // if (encryptPin === 'JduzUhvWIK8NbEu543Ujzw==') {
            $.tuanIds.push(tuanId);
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    $.newShareCodes = ['rR0iS78iapcvappblWjrcQ==', 'JduzUhvWIK8NbEu543Ujzw==', 'ifkD0hvnFL_puKsk-p_k9Q==', 'RKSvznhfaR7IMpXer_dbEw=='];
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    $.shareCodesArr = ['rR0iS78iapcvappblWjrcQ==', 'JduzUhvWIK8NbEu543Ujzw==', 'ifkD0hvnFL_puKsk-p_k9Q==', 'RKSvznhfaR7IMpXer_dbEw=='];
