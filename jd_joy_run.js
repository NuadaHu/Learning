...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["jd_4a12988a5437e", "tao554", "jd_5df32181febec", "JTyz0429", "13643073713_p", "jd_7128839b4eead", "%E6%9E%97_%E5%B0%8F%E8%8D%89", "jd_5e0f310e1bdf6", "aiqingoo_m", "dhcding", "jd_677604b460c0a", "jd_aFYmsIZDqkkY"];

//下面给出好友赛跑助力的示例填写规则
let run_pins = ["jd_4a12988a5437e", "tao554", "jd_5df32181febec", "JTyz0429", "13643073713_p", "jd_7128839b4eead", "%E6%9E%97_%E5%B0%8F%E8%8D%89", "jd_5e0f310e1bdf6", "aiqingoo_m", "dhcding", "jd_677604b460c0a", "jd_aFYmsIZDqkkY"];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_4a12988a5437e", "tao554", "jd_5df32181febec", "JTyz0429", "13643073713_p", "jd_7128839b4eead", "%E6%9E%97_%E5%B0%8F%E8%8D%89", "jd_5e0f310e1bdf6", "aiqingoo_m", "dhcding", "jd_677604b460c0a", "jd_aFYmsIZDqkkY"];
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('jd_4a12988a5437e'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('tao554'), 1));
