/*
8.20-8.30 联合开卡 [jd_opencardUnion2.js]
新增开卡脚本
一次性脚本
...
加购获得抽盲盒1次 有机会获得5京豆 (有可能是空气💨 默认不加购 如需加购请设置环境变量[opencardUnion2_addSku]为"true"
抽盲盒有机会获得京豆(有可能是空气💨
...
[task_local]
#8.20-8.30 联合开卡
28 8,21 20-30 8 * https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnion2.js, tag=8.20-8.30 联合开卡, enabled=true

================Loon==============
cron "28 8,21 20-30 8 *" script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnion2.js,tag=8.20-8.30 联合开卡

===============Surge=================
8.20-8.30 联合开卡 = type=cron,cronexp="28 8,21 20-30 8 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnion2.js

============小火箭=========
8.20-8.30 联合开卡 = type=cron,script-path=https://raw.githubusercontent.com/he1pu/JDHelp/main/jd_opencardUnion2.js, cronexpr="28 8,21 20-30 8 *", timeout=3600, enable=true
*/
...
let union2_addSku = false
union2_addSku = $.isNode() ? (process.env.opencardUnion2_addSku ? process.env.opencardUnion2_addSku : `${union2_addSku}`) : ($.getdata('opencardUnion2_addSku') ? $.getdata('opencardUnion2_addSku') : `${union2_addSku}`);
message = ""
!(async () => {
  if (!cookiesArr[0]) {
...
async function run(){
  try{
    ...
    if($.isCartAward == 0){
      console.log('未加购')
      if(union2_addSku+"" != "true"){
        console.log('如需加购请设置环境变量[opencardUnion2_addSku]为"true"');
      }else await addCart();
